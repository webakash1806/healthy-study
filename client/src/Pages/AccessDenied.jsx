...
import Error403 from '../assets/Img/403error.png'
    ...
    return (
        <div className='bg-[#eaffff] w-screen md:flex-row-reverse md:justify-around h-screen flex flex-col items-center justify-center'>
            ...
            <div className='flex flex-col items-center justify-center'>
                ...
                <button onClick={() => navigate('/')} className='mt-4 bg-[#FFB827] text-black p-[5px] px-4 duration-300 font-semibold rounded-md animate-bounce shadow-sm hover:bg-black hover:text-[#FFB827]'>Go Back!</button>
            </div>
        </div>
    )
}
